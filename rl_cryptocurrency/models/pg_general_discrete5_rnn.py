# Almost same as pg_general_discrete_rnn, except we use 5 discrete actions instead of 2
...
class PGGeneralDiscrete5RNN(PGGeneralDiscreteRNN):
    ...
    def _transform_action(self, action, obs_env):
        ...
        # validity check
        assert 0 <= action <= 4, "Invalid action {:d}!".format(action)
