...
class PGOptimalStopRNN(PGOptimalStop):
    """
    This class is for exploration on RNN approach
    Basic version is the sequence of adjusted price gap
    """
    ...
    def _build_policy_network_op(self):
        """
        Basic RNN: GRU followed by a normal MLP on last time-stamp
        """
